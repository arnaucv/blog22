...
CREATE TABLE `comments` (
  ...
  PRIMARY KEY (`id`),
  KEY `comments_users_id_foreign` (`users_id`),
  KEY `comments_posts_id_foreign` (`posts_id`),
  CONSTRAINT `comments_posts_id_foreign` FOREIGN KEY (`posts_id`) REFERENCES `posts` (`id`),
  CONSTRAINT `comments_users_id_foreign` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `post_has_tags` (
  ...
  KEY `post_has_tags_posts_id_foreign` (`posts_id`),
  KEY `post_has_tags_tags_id_foreign` (`tags_id`),
  CONSTRAINT `post_has_tags_posts_id_foreign` FOREIGN KEY (`posts_id`) REFERENCES `posts` (`id`),
  CONSTRAINT `post_has_tags_tags_id_foreign` FOREIGN KEY (`tags_id`) REFERENCES `tags` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-03-07 17:03:02
